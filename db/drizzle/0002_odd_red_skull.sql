...
CREATE TABLE `__new_Todo` (
	...
	`created_at` integer DEFAULT '"2025-03-21T05:50:59.378Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-03-21T05:50:59.378Z"' NOT NULL
);
...
CREATE UNIQUE INDEX `asfad` ON `Todo` (`id`);